...
export class SchemaLoader {
  ...
  _subSchema1: {
    ...
    /* Version 3 `disallow` */
    disallow(schema: any): void
    /* Version 4 `anyOf` */
    anyOf(schema: any): void
    /* Version 4 `dependencies` (schema dependencies) */
    dependencies(schema: any): void
    /* Version 4 `not` */
    not(schema: any): void
  }
  _subSchema2: {
    /* allOf schemas should be merged into the parent */
    allOf(schema: any, extended: any): any
    /* extends schemas should be merged into parent */
    extends(schema: any, extended: any): any
    /* parent should be merged into oneOf schemas */
    oneOf(schema: any, extended: any): any
  }
  ...
  _expandSubSchema (subschema) {
    /* Array of types */
    if (Array.isArray(subschema)) return subschema.map(m => typeof m.value === 'object' ? this.expandSchema(m) : m)
